# Implementations from: [Github: karolzak/keras-unet](https://github.com/karolzak/keras-unet)
...
# Helper function to create the unet convolutional blocks
def conv2d_block(
    inputs,
    use_batch_norm=True,
    dropout=0.3,
...
# Load original vanilla unet architecture proposed in the paper
def vanilla_unet(
    input_shape,
    num_classes=1,
    dropout=0.5, 
